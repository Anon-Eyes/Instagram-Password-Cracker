...
print("                \033[91mWELCOME ANONEYES")

ascii_banner = pyfiglet.figlet_format("ANON EYES")
print(ascii_banner)
...
print("")
print("\33[94m⊰᯽⊱┈──╌❊   FRAMEWORK BY ANON EYES ❊╌──┈⊰᯽⊱ \t")
print("\33[94m⊰᯽⊱┈──╌❊ CODED BY ANON EYES❊╌──┈⊰᯽⊱ \t")
...
for line in Lines:
    try:
        ...
        time.sleep(0.1) # add a delay of 5 seconds before each login attempt)
